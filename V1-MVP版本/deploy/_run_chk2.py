"""Check import - run from the backend directory"""
import subprocess, sys

SSH_KEY = r'C:\Users\rex.zhu\.ssh\rex_root.pem'
SSH_HOST = 'root@47.107.77.15'
LOCAL_PY = r'E:\new party\nw-party-prototype\V1-MVP版本\deploy\_chk_import2.py'
REMOTE_PY = '/tmp/_chk_import2.py'
...
r = subprocess.run(['ssh', '-i', SSH_KEY, '-o', 'StrictHostKeyChecking=no',
    ...
    'source /var/www/nwparty/venv/bin/activate && cd /var/www/nwparty/src/backend && python3 /tmp/_chk_import2.py 2>&1'],
