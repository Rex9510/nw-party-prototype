...
(async () => {
  ...
  await page.goto('http://127.0.0.1:8081/pc-admin/login.html', { waitUntil: 'load', timeout: 30000 });
  await new Promise(r => setTimeout(r, 2000));
  await page.evaluate(() => {
    try { localStorage.setItem('nw_admin_demo_session', '1'); } catch(e) {}
  });
  await page.goto('http://127.0.0.1:8081/pc-admin/index.html', { waitUntil: 'load', timeout: 30000 });
